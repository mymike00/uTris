...
UBUNTU_TRANSLATION_DOMAIN="utris.mymike"
...
aptest.commands = bash $$PWD/uTris/tests/autopilot/run
aptest.depends  = sub-uTris

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/uTris/tests/unit 
unittest.depends  = sub-uTris
